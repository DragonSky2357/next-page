package com.dragonsky.nextpage.book.domain.service.impl;

import com.dragonsky.nextpage.book.domain.converter.BookConverter;
import com.dragonsky.nextpage.book.domain.entity.Book;
import com.dragonsky.nextpage.book.domain.exception.BookErrorCode;
import com.dragonsky.nextpage.book.domain.exception.BookException;
import com.dragonsky.nextpage.book.domain.repository.reader.BookReader;
import com.dragonsky.nextpage.book.domain.repository.store.BookStore;
import com.dragonsky.nextpage.book.domain.service.BookService;
import com.dragonsky.nextpage.book.domain.util.BookUtils;
import com.dragonsky.nextpage.book.domain.vo.BookItem;
import com.dragonsky.nextpage.book.infra.naver.api.NaverApiClient;
